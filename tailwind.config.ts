  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 10px rgba(255, 90, 0, 0.3)" },
          "50%": { boxShadow: "0 0 20px rgba(255, 90, 0, 0.5)" },
        },
      },
      animation: {
      ...
      backgroundImage: {
        ...
        "gradient-orange-dark": "linear-gradient(135deg, #0F0F12 0%, #1B1B1F 50%, #FF4500 100%)",
      },
      boxShadow: {
        "neon-sm": "0 0 10px rgba(255, 90, 0, 0.2)",
        "neon-md": "0 0 20px rgba(255, 90, 0, 0.3)",
        "neon-lg": "0 0 30px rgba(255, 90, 0, 0.4)",
